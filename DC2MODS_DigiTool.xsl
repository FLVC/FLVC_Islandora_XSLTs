...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <!--
        ...
        ********
        ...
        This stylesheet will transform DigiTool Dublin Core (that is, any DC exported from FLVC's DigiTool instance) to MODS version 3.4.
    ...
    <xsl:template match="record">
        <mods version="3.4" xmlns="http://www.loc.gov/mods/v3" 
            ...
            <xsl:call-template name="dcMain_digitool"/>
        </mods>
    </xsl:template>
    
    <xsl:template name="dcMain_digitool">
        <!-- titleInfo -->
        ...
        <xsl:call-template name="digitool_pid"/> <!-- digitool only -->
